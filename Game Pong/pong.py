...
wn.tracer(0) #that stops the windows to automatic update and serves to speed up the game
...
while True:
    ...
    if ball.xcor() < -340 and ball.ycor() < paddle_a.ycor() + 50 and ball.ycor() > paddle_a.ycor() - 50:
        ball.dx *= -1 
        os.system("afplay bounce.wav&") # the & sign is to prevent the game to freeze, play the sound and unfreeze, now it will play without make the game freeze
